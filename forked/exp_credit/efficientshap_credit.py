...
if __name__ == "__main__":
  ...
  if args.softmax:
    shapley_value, shapley_rank, total_time = efficient_shap(
        model_for_shap.forward_softmax_1, model_for_shap.forward_softmax_1, data_loader, reference,
    ...
    shapley_value, shapley_rank, total_time = efficient_shap(
        model_for_shap.forward_1, model_for_shap.forward_1, data_loader, reference,
        dense_feat_index, sparse_feat_index, cate_attrib_book)
