...
# from credit_model import mlp
from credit_dataset.credit_model import mlp
...
def load_raw_data(path):
  ...
  real_attribs = ["age", "balance", "day", "duration", "campaign", "pdays", "previous"]
...
if __name__ == "__main__":
  ...
  round_num = 0
  datasets_torch, cate_attrib_book, dense_feat_index, sparse_feat_index = load_data('./credit_dataset/bank-full-dataset.csv', val_size=0.2, test_size=0.2, run_num=round_num)
  ...
  # save_checkpoint("./credit_dataset/model_credit_m_1_r_" + str(round_num) + ".pth.tar",
